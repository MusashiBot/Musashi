...
exports.matcher = exports.KeywordMatcher = exports.SYNONYM_MAP = void 0;
const mock_markets_1 = require("../data/mock-markets");
// ─── Stop words ──────────────────────────────────────────────────────────────
...
function expandWithSynonyms(tokens) {
    ...
    for (const token of tokens) {
        const syns = exports.SYNONYM_MAP[token.toLowerCase()];
        if (syns) {
            for (const s of syns)
                expanded.add(s);
        }
...
class KeywordMatcher {
    constructor(markets = mock_markets_1.mockMarkets, minConfidence = 0.22, // Raised from 0.12 to reduce false positives
    maxResults = 5) {
...
// Singleton instance
exports.matcher = new KeywordMatcher();
